...
```bash
&{../example.json 1 0x1497640 {{0 0} 0 0 0 0} map[h:1.01 n:map[a:test] x:http://www.example.com a:Easy! b:map[d:[3 4] c:map[cbd:[3 4] e:Just Do it f:2 g:ON t:1day cn:map[a:test]]]]}
get a Easy!		= Easy!
...
get b config		= &{ 0 0x1497640 {{0 0} 0 0 0 0} map[b:map[c:map[e:Just Do it f:2 g:ON t:1day cn:map[a:value] cbd:[3 4]] d:[3 4]]]}
...
last dump	=
{"a":"Difficult!","b":{"c":{"cbd":[3,4],"cn":{"a":"value"},"d":"d","e":"Correct","f":2,"g":false,"t":"1day"},"d":["1","2","3"]},"h":{"a":[false,true,false],"b":"10T","f":[1.2,2.3,3.4]},"n":{"a":"value"},"x":"http://www.example.com"}
```
